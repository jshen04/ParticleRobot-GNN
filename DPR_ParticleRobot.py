...
class ParticleRobot:
    ...
    def __init__(self, pos, goal, botId, numPaddles = 4 * 4,
        ...
        self.prevCOM = pos
        self.currCOM = pos
        # super(ParticleRobot, self).__init__(botId=botId, shape=bot_shape, paddles=paddles, joints=joints, motors=motors)
    ...
    def updateCOM(self):
        ...
        self.currCOM = self.body.position

    #TODO figure out how to normalize observations
